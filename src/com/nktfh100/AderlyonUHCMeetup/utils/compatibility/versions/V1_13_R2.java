...
public class V1_13_R2 implements PluginVersion {

	Map<String, BiomeBase> biomeBackup = new HashMap<>();

	public void biomeSwapper() {
		List<BiomeBase> base = (List<BiomeBase>) IRegistry.BIOME.f().collect(Collectors.toList());
	...
	public void swap(BiomeData from, BiomeData to) {
		IRegistry.BIOME.a(from.getId(), new MinecraftKey(to.getKey_1_13().toLowerCase()), this.biomeBackup.get(to.getKey_1_13().toLowerCase()));
	}
