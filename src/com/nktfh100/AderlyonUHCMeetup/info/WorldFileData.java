...
//		Bukkit.getLogger().info("x: "+x+"  z: "+z+"  offset: "+coordToRegionOffset(x, z));
	...
	public boolean isChunkFullyGenerated(int x, int z) { // if all adjacent chunks exist, it should be a safe enough bet that this one is
															// fully generated
...
//		testImage(region, data);
	...
	private void sendMessage(String text) {
		UHCMeetup.getInstance().getLogger().info("[WorldData] " + text);
	}
